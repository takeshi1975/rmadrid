...
public class SWGesauroRM extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/desar/workspace/realmadrid/wsdl/rm.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SWGesauroRM.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/desar/workspace/realmadrid/wsdl/rm.wsdl");
        }
        WSDL_LOCATION = url;
    }
